...
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mBorderInsideColor != defaultColor
			...
			radius = (defaultWidth <=defaultHeight ? defaultWidth-mBorderThickness*2
			...
			Log.i("-----radius   in--------", String.valueOf(radius + mBorderThickness/2
					));
			Log.i("-----radius-----out---", String.valueOf(radius + mBorderThickness
					+ mBorderThickness / 2));
